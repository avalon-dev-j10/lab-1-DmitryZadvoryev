   ...
   public void setAddress(String country, String city, String street, String houseOfNumber, String door){
    ...
    public String getFullName() {
     ...
     public String getAddress(){
        ...
        return address.getCountry()+ ", " +address.getCity()+ ", " +address.getStreet()+ ", " +address.getNumberOfHouse()+ ", " +address.getDoor();    
    ...
    public String getPassport(){
        ...
        return passport.getSeriesAndNumber()+ ", " +passport.getBirthDate()+ ", " +passport.getDateOfIssue()+ ", " +passport.getIssuingAuthority();    
